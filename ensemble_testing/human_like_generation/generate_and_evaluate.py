...
#         return self._generate(texts, instruction=instruction)
...
#     parser.add_argument('--baselines', type=str, default="likelihood,logrank,LRR,DetectGPT,NPR",
...
#         data_normal, args, n_perturbation_list, model_config, baselines=baselines
#     )
    
#     print("\n" + "=" * 80)
#     print("EVALUATING HUMAN-LIKE GENERATION")
#     print("=" * 80)
#     results_human_like = run_all_baselines(
#         data_human_like, args, n_perturbation_list, model_config, baselines=baselines
#     )
